...
describe TokyoMessenger::Query, "with an open database" do
  before do
    @db = TokyoMessenger::Table.new('127.0.0.1', 45001)
    @db.clear
  ...
  it "should get a query object" do
    @db.query.class.should == TokyoMessenger::Query
  end
  ...
  it "should query multiple servers" do
    servers = { 1 => TokyoMessenger::Table.new('127.0.0.1', 45001),
                2 => TokyoMessenger::Table.new('127.0.0.1', 45002) }
    ...
    results = TokyoMessenger::Query.parallel_search(*queries)
